...
def train_isolation_forest(df):
    ...
    # Use a contamination rate that matches grid-searched optimal performance
    contamination = 0.10
...
def sanity_test(rf, scaler, iso, iso_scaler):
    ...
    # ISO -- normal sensors (representative value near means of SKAB dataset)
